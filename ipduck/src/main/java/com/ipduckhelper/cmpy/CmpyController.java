...
public class CmpyController {
	...
	@ResponseBody
	public Integer Crt_Cmpy(HttpServletRequest request, @ModelAttribute Cmpy entity) throws Exception{
		return cmpyService.Crt_Cmpy(entity);
	}
	
	@RequestMapping(value = "/srch/list/cmpy/do", method=RequestMethod.POST)
	@ResponseBody
	public List<Cmpy> Srch_Cmpy_List(@ModelAttribute Cmpy entity) throws Exception{
		return cmpyService.Srch_Cmpy_List(entity);
	}
	
	@RequestMapping(value = "/srch/cmpy/do", method=RequestMethod.POST)
	@ResponseBody
	public Cmpy Srch_Cmpy(@ModelAttribute Cmpy entity) throws Exception{
		return cmpyService.Srch_Cmpy(entity);
	}
	
	@RequestMapping(value = "/fix/cmpy/do.admin", method=RequestMethod.POST)
	@ResponseBody
	public Integer Fix_Cmpy(HttpServletRequest request, @ModelAttribute Cmpy entity) throws Exception{
